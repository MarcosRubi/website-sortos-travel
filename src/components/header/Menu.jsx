...
function Menu () {
  ...
  const { active, changeActive, activeChild, changeActiveChild } = useMenuStore()
  ...
  const setActiveBasedOnURL = () => {
    ...
    changeActive(activeMenuItem.parent)
    changeActiveChild(activeMenuItem.child)
  }
